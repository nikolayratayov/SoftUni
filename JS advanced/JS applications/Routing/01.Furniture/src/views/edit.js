...
async function onSubmit(e){
    ...
    let res = await updateById(id, {make, model, year, description, price, img, material})
        ...
        <div class="row space-top">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="new-image" type="text" name="img" .value="/JS advanced/JS applications/Routing/01.Furniture/${item.img}">
                </div>
                <div class="form-group">
